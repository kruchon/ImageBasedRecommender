...
public class FakeRecognizerFromExcel implements Recognizer {
    ...
    private static final String TAGS_PATH = "C:\\gradcit\\recommender\\testdata\\tags.xls";

    @PostConstruct
    protected void openTagsSheet() throws IOException {
        File file = new File(TAGS_PATH);
    ...
    private RecognitionResult createResult(Row row) {
        ...
        String thematics = row.getCell(2).getStringCellValue().toLowerCase();
